    ...
    <div className="bg-slate-50 min-h-screen">
      ...
      <div className="p-6 max-w-lg mx-auto">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="tontigo-card p-6 space-y-5">
            <div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="tontigo-input pl-12 font-bold"
                  required
                />
              </div>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="tontigo-input pl-12 appearance-none"
                  >
            ...
            <div className="bg-slate-50 p-4 rounded-2xl flex items-start gap-3">
              <Info size={16} className="text-tontigo-orange mt-0.5" />
          ...
          <div className="tontigo-card p-6 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-orange-100 rounded-xl flex items-center justify-center text-tontigo-orange">
                <Shield size={20} />
              </div>
              <div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="btn-tontigo w-full justify-center py-5 shadow-xl shadow-orange-500/20"
          >
