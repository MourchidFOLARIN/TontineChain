                    ...
                    <tr>
                        <td style="padding: 0 40px 40px 40px; text-align: center;">
                            ...
                            <p style="font-size: 15px; color: #475569; line-height: 1.6; margin-bottom: 30px;">
                                Pour finaliser votre connexion à <strong>TontineChain</strong>, veuillez utiliser le code de confirmation suivant :
                            </p>
                            ...
                            <div style="margin-top: 35px; padding: 20px; background-color: #F1F5F9; border-radius: 12px; text-align: left;">
                                <p style="font-size: 13px; color: #475569; line-height: 1.6; margin: 0;">
                                    <strong style="color: #EF4444;">Sécurité :</strong> Ne partagez jamais ce code. L'équipe TontineChain ne vous le demandera jamais par téléphone ou message.
                                </p>
                            </div>
                        </td>
                    </tr>
